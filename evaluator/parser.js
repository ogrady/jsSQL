...
var T = {
    ...
    AND :          new Symbol("∧",   10, false),
    OR :           new Symbol("∨",    5, false),
    NOT :          new Symbol("¬",   70, false),
    GT:            new Symbol(">",    1, false),
    GTE :          new Symbol("≥",    1, false),
    LT:            new Symbol("<",    1, false),
    LTE :          new Symbol("≤",    1, false),
    NEQ :          new Symbol("≠",    1, false),
    EQ :           new Symbol("≡",    1, false),
    EXISTS :       new Symbol("∃",    1, false),
    ALL :          new Symbol("∀",    1, false),
    MINUS :        new Symbol("-",   25, true),
    PLUS :         new Symbol("+",   25, true),
    TIMES :        new Symbol("*",   50, true),
    DIVIDED_BY :   new Symbol("/",   50, true),
    PERIOD :       new Symbol(".",   75, true   ),
